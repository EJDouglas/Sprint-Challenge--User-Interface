...
(1) Display: inline-block does not add a line-break after the element, so the element can sit next to other elements. (2) Display: inline-block allows to set a width and height on the element.
...
Git is valuable to a team because you can revisit old versions of code as members of your team are working. If the code gets confused along the way you can compare it to older versions to see where you went wrong. 
